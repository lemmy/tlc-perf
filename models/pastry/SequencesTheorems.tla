...
\* This seems to be another Zenon bug  (*{_}*)BY <1>5, SeqDef
PROOF (*{_}*)OMITTED
<1>7. CASE Len(seq)-1 \notin Nat
  <2>1. \A n \in Nat : n-1 \notin Nat => 1..(n-1) = 1..0
  ...
  <2>4. (0 \in Nat)
    (*{_}*)BY Arithmetic
  <2>5. QED
\* XXX Zenon bug again:    (*{_}*)BY <2>3, <2>4, SeqDef
PROOF (*{_}*)OMITTED
<1>8. QED
  (*{_}*)BY <1>6, <1>7
