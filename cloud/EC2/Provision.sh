...
ssh-keygen -t rsa -N "" -C "AWS out key" -f /home/kuppe/.ssh/id_rsa
# Add hosts we know of to known_hosts
...
# sync
sudo -u kuppe ssh ec2perf@tla.msr-inria.inria.fr mkdir -p /var/lib/ec2perf/rrdtool/\$BUILD_ID
