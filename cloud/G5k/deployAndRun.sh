...
ssh `head -n 1 /home/mkuppe/$OAR_JOB_ID.nodes` "/home/mkuppe/grid5000.git/tlc.sh $1 $2 $3 $4 $5$OAR_JOB_ID /home/mkuppe/$OAR_JOB_ID.nodes /home/mkuppe/grid5000.git /tmp "" $6 $7 $8 $9 $10 $11"
