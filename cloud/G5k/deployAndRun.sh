...
export MASTER_CLASS=$10
export WORKER_CLASS=$11
ssh `head -n 1 /home/mkuppe/$OAR_JOB_ID.nodes` "/home/mkuppe/grid5000.git/tlc.sh $1 $2 $3 $4 $5$OAR_JOB_ID /home/mkuppe/$OAR_JOB_ID.nodes /home/mkuppe/grid5000.git /tmp /var/lib/munin/tlc \"$6\" \"$7\" \"$8\" \"$9\""
